    ...
    return `
      ...
      <body>
        <div class="header">
          ...
          <div class="header-title">Relatório de Queda</div>
          ...
          <div class="header-badges">
            ...
            ${handled
              ? `<span class="header-pill">✅ ${t('fallOccurrence.handled')}</span>`
              : `<span class="header-pill header-pill-danger">⚠️ ${t('fallOccurrence.unhandled')}</span>`}
            ${isFalseAlarm ? `<span class="header-pill header-pill-danger">⚠️ ${t('fallOccurrence.falseAlarm')}</span>` : ''}
          </div>
        </div>
            ...
            <div class="section-body">
              <table class="info-table">
                ...
                ${row(t('fallOccurrence.status'), handled
                  ? `<span class="badge badge-handled">✅ ${t('fallOccurrence.handled')}</span>`
                  : `<span class="badge badge-unhandled">⚠️ ${t('fallOccurrence.unhandled')}</span>`)}
                ${isFalseAlarm ? row('', `<span class="badge badge-false-alarm">⚠️ ${t('fallOccurrence.falseAlarm')}</span>`) : ''}
                ${data?.handler ? row(t('fallOccurrence.handledBy'), handlerName) : ''}
                ${data?.description ? row(t('fallOccurrence.description'), data.description) : ''}
              </table>
            </div>
          </div>
