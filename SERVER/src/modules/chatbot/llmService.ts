...
function buildSystemPrompt(lang: HelpLang, role: UserRole | undefined): string {
  ...
  if (lang === 'pt') {
    return [
      ...
      '5. Responde sempre em Português, em texto simples (sem markdown), no máximo 4 frases curtas.',
      '6. Adapta a resposta ao papel do utilizador.',
      '',
  ...
  return [
    ...
    '5. Always answer in English, plain text (no markdown), at most 4 short sentences.',
    '6. Tailor the answer to the user role.',
    '',
